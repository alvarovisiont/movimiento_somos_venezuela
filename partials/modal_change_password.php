    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color: #C92020; color: white;">
                <h4 class="modal-title">Reestablecer Contraseña por Defecto&nbsp;<i class="fa fa-warning"></i></h4>
            </div>
            <!-- #076DF7 -->
...
<script>
	...
	$('#form_password_reset').submit(function(e) {
		...
		$.ajax({
			url: '<?= $_SESSION["base_url1"]."app/estado/operaciones.php" ?>',
			type: 'POST',
			dataType: 'JSON',
			data: $(this).serialize(),
		})
		.done(function(data) {
			if(data.r)
			{
				toastr.success('Su contraseña ha sido reestablecida','Éxito!')
